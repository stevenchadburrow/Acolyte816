...
cd ~/Projects/PIC16 ; ~/Projects/sdcc-4.3.0/bin/sdcc --use-non-free -mpic14 -p16f886 LastAcolyte6.c ; cd ~/Projects/minipro ; ./minipro -p "pic16f886" -w ~/Projects/PIC16/LastAcolyte6.hex ; ./minipro -p "pic16f886" -c config -w ~/Projects/PIC16/LastAcolyte6.fuses -e
...
const unsigned char codeA[256] = {
	...
	
};

// bootloader code that goes at 0x00FF00 to 0x00FFFF
const unsigned char codeB[256] = {
	
};
		...
		for (unsigned char j=0; j<16; j++) // 16 packets of 16 bytes each
		{
			if (i == 0 && j == 0) // first 16 byte packet
			{
				if (jump != 0x00) // if jumping, load jump instruction
				{
					...
					packet[1] = 0x00;
					packet[2] = 0xE0;
					packet[3] = 0x03; // jump location of $03E000
