// AcolyteAssembler.cpp

// Acolyte Assembler for the W65C816S

// g++ -o AcolyteAssembler.o AcolyteAssembler.cpp
...
{
	printf("Acolyte Assembler for the W65C816S 8/16-bit CPU\n");
