...
0xFF,0xEC,0xDC,0xFF,0xF0,0xF8,0xEE,0xDD,0xFF,0xBD,0x00,0xFD,0xC9,0xF0,0xD0,0x05,
...
0xDC,0xFF,0x9D,0x00,0xFD,0x8A,0x1A,0x8D,0xDC,0xFF,0xFA,0x68,0x40,0xC9,0x0B,0xF0,
...
uint32_t KEY_ARRAY = 0x0000FD00; // need the location for keyboard buffer
...
{
	for (unsigned long i=0; i<16777216; i++) // randomize all memory
	{
		MEMORY[i] = rand() % 256;
	}
